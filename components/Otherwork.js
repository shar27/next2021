      ...
      >
        <div className="text-black ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300  border-white shadow-slate-500 bg-white hover:opacity-95 rounded-lg container p-5">
          ...
          <Image
            ...
            onClick={(event) =>
              (window.location.href = "https://spendlet.com/")
            }
            alt="spendlet"
            src="/spendlet.PNG"
            width="500px"
          ...
          <Link href="https://spendlet.com/">
            <a className="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-blue-700 duration-300 text-white font-bold rounded-lg p-4 text-lgxt-white">
              Live site
            </a>
          </Link>
        </div>
        ...
        <div className="text-black ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300  border-white shadow-slate-500 bg-white hover:opacity-95 rounded-lg container p-5">
          ...
          <Image src="/gatsbyjs.jpg" width="100" height="100" />
          <Image src="/contentful.png" width="100" height="100" />
          ...
          <Image
            ...
            onClick={(event) =>
              (window.location.href =
                "https://github.com/shar27/gatsby-contentful-podcast")
            }
            alt="podcast"
            src="/podcast.jpg"
            width="500px"
        ...
        <div className="text-black ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300  border-white shadow-slate-500 bg-white hover:opacity-95 rounded-lg container p-5">
          ...
          <Image
            className="mt-10 rounded-lg "
            onClick={(event) =>
              (window.location.href = "https://teacher-esl.com")
            }
            alt="wise"
            src="/candles.jpg"
            width="500px"
        ...
        <div className="text-black ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300  border-white shadow-slate-500 bg-white hover:opacity-95 rounded-lg container p-5">
          ...
          <Image src="/ts.png" width="100" height="100" />
          <Image src="/tailwind-css.png" width="100" height="100" />
        ...
        <div className="text-black ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300  border-white shadow-slate-500 bg-white hover:opacity-95 rounded-lg container p-5">
          <h1 className="text-2xl  text-black">Teaching-ESL</h1>
          <Image src="/nextjs.png" width="100" height="100" />
          <Image src="/stripe.png" width="100" height="100" />
          <Image src="/tailwind-css.png" width="100" height="100" />
          <Image src="/contentful.png" width="100" height="100" />
